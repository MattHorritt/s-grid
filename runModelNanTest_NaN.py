...
#############################################################################
# Control Panel
parametersFile="params_NanTest_Nan.pck" # Output from buildModel.py

outputDirectory="results_NanTest" # Folder for results
outputPrefix="output_Nan"  # Filename for results is based on this
